...
public class PlayerRandomTeleportEvent extends Event implements Cancellable {
    ...
    public PlayerRandomTeleportEvent(Player player, boolean useIA, Location loc, String actionbar, String title, String sub, String message) {
        super(false);
        this.player = player;
        this.useIA = useIA;
        this.loc = loc;
